	...
	return (
		<nav className="">
			<ul className="flex justify-center list-none text-center gap-3">
				...
				<li className="mx-0">
					<Link
						className={`hover:bg-transparent flex-start text-center hover:text-mainTextColor ${colorHome} border-[2px] border-mainColor rounded-[3px] border-solid no-underline transition-[0.5s] m-[25px_0] p-[12px_12px] w-[80px] text-center flex content-between`}
						to="/"
						onClick={corHome}
					>
