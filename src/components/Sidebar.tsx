...
export default function Sidebar() {
  return (
    <div
      id="Sidebar"
      className="no-underline hover:no-underline overflow-y-auto scrollbar no-scrollbar flex flex-col sm:fixed text-center sm:min-h-screen h-full sm:w-full md:w-1/4 items-center text-mainTextColor bg-bioBgColor p-[20px_12px] md:border-r-[5px]"
    >
      ...
      <ul className="w-[200px]  flex items-center mx-auto list-none border-b-[1px] border-solid mb-[25px] pb-[25px]">
        <li className="max-w-[60px] mx-auto">
          <a
            className="text-[30px] text-mainColor hover:text-[40px] transition-[1s] hover:text-mainTextColor"
        ...
        <li className="max-w-[60px]  mx-auto">
          <a
            className="text-[30px] hover:text-[40px] transition-[1s] text-mainColor hover:text-mainTextColor"
      ...
      <div className="flex hover:text-[17px] transition-[1s] justify-center w-[100%]">
        <a
