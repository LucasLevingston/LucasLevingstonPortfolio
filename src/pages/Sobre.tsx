    ...
    <div className="w-full flex flex-col sm:flex-row h-full text-mainTextColor">
      ...
      <div className="flex-1 p-[50px]  sm:max-w-[75%] ml-auto mr-0 bg-aboutBgColor">
        ...
        <div className="overflow-y-auto">
          ...
          <h2
            className="border-t-[1px] 2xl:text-7xl border-solid pt-10 border-mainTextColor mb-5 text-[32px]"
            id="skills-section-title"
          >
            Minhas Skills
          </h2>
          <div className="border-b-[1px] 2xl:text-7xl border-solid pt-3 border-borderColor">
          ...
          <div>
            <div className="text-2xl pb-2 2xl:text-6xl 2xl:pb-10 pt-5 2xl:pt-7">
              Minhas experiências:
            </div>
