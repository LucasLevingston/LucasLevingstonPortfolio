...
export const certificatesDataBr: CertificatesType[] = [
	...
	},
	{
		...
		image: certificateImages.ambienteJava,
		description: ['Configuração de um ambiente de desenvolvimento Java.'],
		technologies: ['java', 'eclipse', 'intellij', 'fundamentos java', 'orientação a objeto', 'programação funcional', 'mysql', 'mongodb', 'spring boot', 'javafx', 'jpa', 'hibernate'],
		hours: 8,
		startsDate: '01/2022',
	...
	},
	{
		...
		image: certificateImages.satanderOpenAcademy,
		description: [
			'Certificado de conclusão da formação TypeScript Fullstack Developer pela DIO. Veja o certificado: https://www.dio.me/certificate/BF5B88BW/share'
		],
		hours: 63,
		startsDate: '11/2025',
		completionDate: '01/2026',
		technologies: ['python', 'excel', 'git', 'github', 'ia', 'postgresql', 'mongo'],
	},
];
...
export const certificatesDataEn: CertificatesType[] = [
	...
	},
	{
		...
		image: certificateImages.satanderOpenAcademy,
		description: [
			'Certificate of completion for the TypeScript Fullstack Developer bootcamp by DIO. See certificate: https://www.dio.me/certificate/BF5B88BW/share'
		],
		hours: 63,
		startsDate: '11/2025',
		completionDate: '01/2026',
