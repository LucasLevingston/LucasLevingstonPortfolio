export const recommendationDataBr: RecommendationType[] = [
	{
		name: 'Lucas Henrique',
		linkedinImageUrl:
		...
		comments:
			'Profissional e excelente, muito competente. Teve participação muito importante na idealização e implementação de diversas features tanto no front-end quanto no back-end do projeto.',
		company: 'Splendore',
	},
];
export const recommendationDataEn: RecommendationType[] = [
	{
		name: 'Lucas Henrique',
